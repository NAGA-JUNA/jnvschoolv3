...
<div class="split-container">
    <div class="left-panel"><div class="left-content"><div class="school-icon"><i class="bi bi-key-fill"></i></div><h1 style="font-size:2rem;font-weight:800"><?= htmlspecialchars($schoolName) ?></h1><p style="opacity:.85">Create a new secure password</p></div></div>
